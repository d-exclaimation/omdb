...
const SkeletonFlexibleFilmPreview: FC = () => {
  return (
    <div className="flex flex-col w-full flex-shrink-0 h-full overflow-hidden bg-white rounded group">
      <div className="object-cover w-full aspect-video rounded overflow-hidden bg-zinc-200 animate-pulse"></div>
      <div className="flex flex-col w-full gap-1 py-2">
        ...
        <div className="flex flex-row w-full items-center justify-start">
          <div className="w-4 h-4 rounded-full mr-1 bg-zinc-200 animate-pulse" />
          <div className="flex flex-row justify-start gap-3 text-zinc-500 text-xs">
            <span className="max-w-[28rem] truncate text-transparent bg-zinc-200 animate-pulse rounded">
              Something Something
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-row justify-between text-zinc-400 gap-3 pr-1 text-xs">
          <span className="rounded bg-zinc-200 animate-pulse text-transparent">
